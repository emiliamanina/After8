...
### Project Structure
```
├── Aftereight2.xcodeproj  - it lets you create and modify Xcode projects from Ruby.      
│ 
├── Aftereight2            - Application components folder
...
```
Brice_SemiBold-Expanded
Brice_Regular-SemiExpanded
Brice_Light-SemiExpanded
Brice_SemiBold-SemiExpanded
Brice_Light-Expanded
Montserrat-Medium
Montserrat-Regular
